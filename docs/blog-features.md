...
На каждую фичу: новый чат → вставить промпт → дождаться PR и `READY FOR REVIEW` → ревью в другом чате → merge человеком при зелёном CI → следующая фича от обновлённого `main`.
